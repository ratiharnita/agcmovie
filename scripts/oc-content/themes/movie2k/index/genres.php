...
function get_numgenres($name){
    ...
    $GET_ID = "SELECT count(*) FROM oc_posts where active = 1 and type = 1 and terms = '$name' or terms2 = '$name' or terms3 = '$name'";
...
$genressql = get_mysqli('oc_terms where type = 1 order by name asc');
...
<table id="tablemovies" cellpadding="5" cellspacing="5">
  <tbody><tr>
    ...
    <td id="tdmovies" width="155"><a href="/page/random">Random</a></td>
  </tr>
</tbody></table>
<?php endforeach; }?>
