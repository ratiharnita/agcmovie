...
function get_numgenres($name){
    ...
    $GET_ID = "SELECT count(*) FROM oc_posts where active = 1 and type = 3 and terms = '$name' or terms2 = '$name' or terms3 = '$name'";
...
$genressql = get_mysqli('oc_terms where type = 5 order by name asc');
