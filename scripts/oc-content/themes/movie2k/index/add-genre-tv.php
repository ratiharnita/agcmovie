...
if(!empty($_POST['name'])){
    ...
    $slug           = permalink($name);
        mysqli_query($db,"INSERT INTO oc_terms (name,slug,type) VALUES ('$name','$slug',5)") or die (mysqli_error($db));
    mysqli_close($db);
}  
} 
                ...
                <tbody>
                 <tr>
                    <td bgcolor="#646464" align="center">
                        <font face="Arial" color="#FFFFFF"><b> ..:: Genre TV Show ::.. </b></font>
                    </td>
                </tr>
               <?php if($action != 'edit'){?>
                <tr>
                    <td bgcolor="#AAAAAA" align="center">
                        ...
                        <table>
                            <tbody>
                              <form method="POST" id="formposturl" action="/page/add-genre-tv&action=add" enctype="multipart/form-data">
                              <tr>
                ...
                <tr>
                    <td bgcolor="#AAAAAA" align="center">
                        ...
                        <table>
                            <tbody>
                              <form method="POST" id="formposturl" action="/page/add-genre-tv&post=<?php echo $row['id'];?>&action=edit" enctype="multipart/form-data">
                              <tr>
                                <td><font face="Arial" color="#000000">Name Genre:</font></td>
                ...
                <?php } ?>
                 <tr>
                    <td bgcolor="#646464" align="center">
                        <font face="Arial" color="#FFFFFF"><b> ..:: List Genre TV Show ::.. </b></font>
                    </td>
                </tr>
                <?php
                          $result     = get_mysqli("oc_terms WHERE type = 5");
                          while ($row = mysqli_fetch_assoc($result)) 
                {
                ?>
                 <tr>
                    <td bgcolor="#AAAAAA" align="left" style="padding:5px 10px;">
                        <a title="Edit <?php echo $row['name'];?>" href="/page/add-genre-tv&post=<?php echo $row['id'];?>&action=edit"><font face="Arial" color="#646464"><b><?php echo $row['name'];?></b></font></a>
                    </td>
                </tr>
                <?php 
                } 
