...
<form method="GET" action="/index.php" accept-charset="UTF-8" id="search">
			...
			<div class="breadcrumb">
				<a href="<?php get_home_url();?>">Home</a> » Search Results for: <?php echo ucwords($id) ;?>
			</div>
			...
			?>
                ...
                <?php if( mysqli_num_rows($oc_search_result) > 0 ) :?>
        	<div class="pagination">
			<?php echo '<ul class="pagination">'.$oc_search->navigation("", "active", false, false, false, true,"<li>","</li>").'</ul>';?>
		</div>
                <?php endif;?>
