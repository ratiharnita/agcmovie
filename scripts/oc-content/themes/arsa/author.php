...
<form method="GET" action="/index.php" accept-charset="UTF-8" id="search">
			...
			<div class="breadcrumb">
				<a href="<?php get_home_url();?>">Home</a> » All posts by <?php echo ucwords($id) ;?>
			</div>
			...
			<?php echo '<ul class="pagination">'.$oc_users->navigation("", "active", false, false, false, true,"<li>","</li>").'</ul>';?>
		</div>
                <?php endif;?>
